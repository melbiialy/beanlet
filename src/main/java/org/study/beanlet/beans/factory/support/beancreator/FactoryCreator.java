...
public class FactoryCreator implements Creator{
    ...
    public Object create(BeanDefinition beanDefinition, DefaultBeanFactory defaultBeanFactory) throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Object[] args = DependencyResolver.resolveDependencies(factoryMethod.getParameters(), defaultBeanFactory);
        return factoryMethod.invoke(defaultBeanFactory.getBean(className),args);
    }
